...
# 学校排名数据初始化
school985 = []
fSchool985 = open(lastPath + '/config/985.txt','r',encoding='utf-8')
...
school211 = []
fSchool211 = open(lastPath + '/config/211.txt','r',encoding='utf-8')
for line in fSchool211.readlines() :
    school211.append(line.strip())
fSchool211.close();

schoolTop300 = []
fSchoolTop300 = open(lastPath + '/config/school.txt','r',encoding='utf-8')
...
# 读取本地cookie
fCookie = open(lastPath + '/config/cookie.txt','r',encoding='utf-8')
